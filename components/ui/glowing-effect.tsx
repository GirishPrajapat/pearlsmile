  ...
  const handleMove = useCallback((e?: MouseEvent | { x: number; y: number }) => {
    ...
    animationFrameRef.current = requestAnimationFrame(() => {
      ...
      if (distanceFromCenter < inactiveRadius) {
        element.style.setProperty("--active", "0"); return;
      }
      ...
      <div
        ...
        style={{
          ...
          "--gradient": variant === "white"
            ...
            : `radial-gradient(circle, #F0B8D0 10%, #F0B8D000 20%),
               radial-gradient(circle at 40% 40%, #7A9E7E 5%, #7A9E7E00 15%),
               radial-gradient(circle at 60% 60%, #D4718A 10%, #D4718A00 20%),
               radial-gradient(circle at 40% 60%, #B8D4BB 10%, #B8D4BB00 20%),
               repeating-conic-gradient(
                 from 236.84deg at 50% 50%,
                 #F0B8D0 0%,
                 #7A9E7E calc(25% / var(--repeating-conic-gradient-times)),
                 #D4718A calc(50% / var(--repeating-conic-gradient-times)),
                 #B8D4BB calc(75% / var(--repeating-conic-gradient-times)),
                 #F0B8D0 calc(100% / var(--repeating-conic-gradient-times))
               )`,
